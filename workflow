 ...
 "cells": [
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "application/3dmoljs_load.v0": "<div id=\"3dmolviewer_16593112433055308\"  style=\"position: relative; width: 640px; height: 480px\">\n        <p id=\"3dmolwarning_16593112433055308\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n        </div>\n<script>\n\nvar loadScriptAsync = function(uri){\n  return new Promise((resolve, reject) => {\n    var tag = document.createElement('script');\n    tag.src = uri;\n    tag.async = true;\n    tag.onload = () => {\n      resolve();\n    };\n  var firstScriptTag = document.getElementsByTagName('script')[0];\n  firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);\n});\n};\n\nif(typeof $3Dmolpromise === 'undefined') {\n$3Dmolpromise = null;\n  $3Dmolpromise = loadScriptAsync('https://3dmol.org/build/3Dmol.js');\n}\n\nvar viewer_16593112433055308 = null;\nvar warn = document.getElementById(\"3dmolwarning_16593112433055308\");\nif(warn) {\n    warn.parentNode.removeChild(warn);\n}\n$3Dmolpromise.then(function() {\nviewer_16593112433055308 = $3Dmol.createViewer($(\"#3dmolviewer_16593112433055308\"),{backgroundColor:\"white\"});\n$3Dmol.download(\"pdb:5WOG\", viewer_16593112433055308, {}, function() {\nviewer_16593112433055308.zoomTo();\n\tviewer_16593112433055308.setStyle({\"cartoon\": {\"color\": \"spectrum\"}});\n\tviewer_16593112433055308.setStyle({\"hetflag\": true},{\"stick\": {\"radius\": 0.3, \"singleBond\": false}});\n\tviewer_16593112433055308.zoomTo();\nviewer_16593112433055308.render();\n})\n});\n</script>",
      "text/html": [
       "<div id=\"3dmolviewer_16593112433055308\"  style=\"position: relative; width: 640px; height: 480px\">\n",
       "        <p id=\"3dmolwarning_16593112433055308\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n",
       "        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n",
       "        </div>\n",
       "<script>\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "application/3dmoljs_load.v0": "<div id=\"3dmolviewer_1659311246691226\"  style=\"position: relative; width: 640px; height: 480px\">\n        <p id=\"3dmolwarning_1659311246691226\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n        </div>\n<script>\n\nvar loadScriptAsync = function(uri){\n  return new Promise((resolve, reject) => {\n    var tag = document.createElement('script');\n    tag.src = uri;\n    tag.async = true;\n    tag.onload = () => {\n      resolve();\n    };\n  var firstScriptTag = document.getElementsByTagName('script')[0];\n  firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);\n});\n};\n\nif(typeof $3Dmolpromise === 'undefined') {\n$3Dmolpromise = null;\n  $3Dmolpromise = loadScriptAsync('https://3dmol.org/build/3Dmol.js');\n}\n\nvar viewer_1659311246691226 = null;\nvar warn = document.getElementById(\"3dmolwarning_1659311246691226\");\nif(warn) {\n    warn.parentNode.removeChild(warn);\n}\n$3Dmolpromise.then(function() {\nviewer_1659311246691226 = $3Dmol.createViewer($(\"#3dmolviewer_1659311246691226\"),{backgroundColor:\"white\"});\n$3Dmol.download(\"pdb:5WOG\", viewer_1659311246691226, {}, function() {\nviewer_1659311246691226.zoomTo();\n\tviewer_1659311246691226.setStyle({\"cartoon\": {\"color\": \"spectrum\"}});\n\tviewer_1659311246691226.setStyle({\"hetflag\": true},{\"stick\": {\"radius\": 0.3, \"singleBond\": false}});\n\tviewer_1659311246691226.zoomTo();\n\tviewer_1659311246691226.setStyle({\"chain\": [\"A\", \"B\"]},{\"cartoon\": {\"color\": \"yellow\"}});\n\tviewer_1659311246691226.addLabel(\"alpha subunits\",{\"fontColor\": \"yellow\", \"backgroundColor\": \"lightgray\"},{\"chain\": [\"A\", \"B\"]});\n\tviewer_1659311246691226.setStyle({\"chain\": [\"C\", \"D\"]},{\"cartoon\": {\"color\": \"blue\"}});\n\tviewer_1659311246691226.addLabel(\"beta subunits\",{\"fontColor\": \"blue\", \"backgroundColor\": \"lightgray\"},{\"chain\": [\"C\", \"D\"]});\nviewer_1659311246691226.render();\n})\n});\n</script>",
      "text/html": [
       "<div id=\"3dmolviewer_1659311246691226\"  style=\"position: relative; width: 640px; height: 480px\">\n",
       "        <p id=\"3dmolwarning_1659311246691226\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n",
       "        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n",
       "        </div>\n",
       "<script>\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "application/3dmoljs_load.v0": "<div id=\"3dmolviewer_165930694132818\"  style=\"position: relative; width: 640px; height: 480px\">\n        <p id=\"3dmolwarning_165930694132818\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n        </div>\n<script>\n\nvar loadScriptAsync = function(uri){\n  return new Promise((resolve, reject) => {\n    var tag = document.createElement('script');\n    tag.src = uri;\n    tag.async = true;\n    tag.onload = () => {\n      resolve();\n    };\n  var firstScriptTag = document.getElementsByTagName('script')[0];\n  firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);\n});\n};\n\nif(typeof $3Dmolpromise === 'undefined') {\n$3Dmolpromise = null;\n  $3Dmolpromise = loadScriptAsync('https://3dmol.org/build/3Dmol.js');\n}\n\nvar viewer_165930694132818 = null;\nvar warn = document.getElementById(\"3dmolwarning_165930694132818\");\nif(warn) {\n    warn.parentNode.removeChild(warn);\n}\n$3Dmolpromise.then(function() {\nviewer_165930694132818 = $3Dmol.createViewer($(\"#3dmolviewer_165930694132818\"),{backgroundColor:\"white\"});\n$3Dmol.download(\"pdb:5WOG\", viewer_165930694132818, {}, function() {\nviewer_165930694132818.zoomTo();\n\tviewer_165930694132818.setStyle({\"cartoon\": {\"color\": \"spectrum\"}});\n\tviewer_165930694132818.setStyle({\"hetflag\": true},{\"stick\": {\"radius\": 0.3, \"singleBond\": false}});\n\tviewer_165930694132818.zoomTo();\n\tviewer_165930694132818.setStyle({\"chain\": [\"A\", \"B\"]},{\"cartoon\": {\"color\": \"yellow\"}});\n\tviewer_165930694132818.addLabel(\"alpha subunits\",{\"fontColor\": \"yellow\", \"backgroundColor\": \"lightgray\"},{\"chain\": [\"A\", \"B\"]});\n\tviewer_165930694132818.setStyle({\"chain\": [\"C\", \"D\"]},{\"cartoon\": {\"color\": \"blue\"}});\n\tviewer_165930694132818.addLabel(\"beta subunits\",{\"fontColor\": \"blue\", \"backgroundColor\": \"lightgray\"},{\"chain\": [\"C\", \"D\"]});\n\tviewer_165930694132818.setStyle({\"resn\": \"HOH\"},{\"sphere\": {\"radius\": 0.5}});\n\tviewer_165930694132818.setStyle({\"resn\": \"HOH\"},{});\n\tviewer_165930694132818.setStyle({\"chain\": \"C\", \"resi\": \"6\"},{\"stick\": {\"colorscheme\": \"redCarbon\"}});\n\tviewer_165930694132818.setStyle({\"chain\": \"D\", \"resi\": \"6\"},{\"stick\": {\"colorscheme\": \"redCarbon\"}});\n\tviewer_165930694132818.setStyle({\"chain\": \"C\", \"resi\": \"6\"},{\"stick\": {\"colorscheme\": \"redCarbon\"}});\n\tviewer_165930694132818.setStyle({\"chain\": \"D\", \"resi\": \"6\"},{\"stick\": {\"colorscheme\": \"redCarbon\"}});\n\tviewer_165930694132818.setStyle({\"resn\": \"HOH\"},{\"sphere\": {\"radius\": 0.5}});\nviewer_165930694132818.render();\n})\n});\n</script>",
      "text/html": [
       "<div id=\"3dmolviewer_165930694132818\"  style=\"position: relative; width: 640px; height: 480px\">\n",
       "        <p id=\"3dmolwarning_165930694132818\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n",
       "        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n",
       "        </div>\n",
       "<script>\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "application/3dmoljs_load.v0": "<div id=\"3dmolviewer_16593040856046562\"  style=\"position: relative; width: 640px; height: 480px\">\n        <p id=\"3dmolwarning_16593040856046562\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n        </div>\n<script>\n\nvar loadScriptAsync = function(uri){\n  return new Promise((resolve, reject) => {\n    var tag = document.createElement('script');\n    tag.src = uri;\n    tag.async = true;\n    tag.onload = () => {\n      resolve();\n    };\n  var firstScriptTag = document.getElementsByTagName('script')[0];\n  firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);\n});\n};\n\nif(typeof $3Dmolpromise === 'undefined') {\n$3Dmolpromise = null;\n  $3Dmolpromise = loadScriptAsync('https://3dmol.org/build/3Dmol.js');\n}\n\nvar viewer_16593040856046562 = null;\nvar warn = document.getElementById(\"3dmolwarning_16593040856046562\");\nif(warn) {\n    warn.parentNode.removeChild(warn);\n}\n$3Dmolpromise.then(function() {\nviewer_16593040856046562 = $3Dmol.createViewer($(\"#3dmolviewer_16593040856046562\"),{backgroundColor:\"white\"});\n$3Dmol.download(\"pdb:5WOG\", viewer_16593040856046562, {}, function() {\nviewer_16593040856046562.zoomTo();\n\tviewer_16593040856046562.setStyle({\"cartoon\": {\"color\": \"spectrum\"}});\n\tviewer_16593040856046562.setStyle({\"hetflag\": true},{\"stick\": {\"radius\": 0.3, \"singleBond\": false}});\n\tviewer_16593040856046562.zoomTo();\n\tviewer_16593040856046562.setStyle({\"chain\": [\"A\", \"B\"]},{\"cartoon\": {\"color\": \"yellow\"}});\n\tviewer_16593040856046562.addLabel(\"alpha subunits\",{\"fontColor\": \"yellow\", \"backgroundColor\": \"lightgray\"},{\"chain\": [\"A\", \"B\"]});\n\tviewer_16593040856046562.setStyle({\"chain\": [\"C\", \"D\"]},{\"cartoon\": {\"color\": \"blue\"}});\n\tviewer_16593040856046562.addLabel(\"beta subunits\",{\"fontColor\": \"blue\", \"backgroundColor\": \"lightgray\"},{\"chain\": [\"C\", \"D\"]});\n\tviewer_16593040856046562.setStyle({\"resn\": \"HOH\"},{\"sphere\": {\"radius\": 0.5}});\n\tviewer_16593040856046562.setStyle({\"resn\": \"HOH\"},{});\nviewer_16593040856046562.render();\n})\n});\n</script>",
      "text/html": [
       "<div id=\"3dmolviewer_16593040856046562\"  style=\"position: relative; width: 640px; height: 480px\">\n",
       "        <p id=\"3dmolwarning_16593040856046562\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n",
       "        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n",
       "        </div>\n",
       "<script>\n",
  ...
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "application/3dmoljs_load.v0": "<div id=\"3dmolviewer_16593068247434082\"  style=\"position: relative; width: 640px; height: 480px\">\n        <p id=\"3dmolwarning_16593068247434082\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n        </div>\n<script>\n\nvar loadScriptAsync = function(uri){\n  return new Promise((resolve, reject) => {\n    var tag = document.createElement('script');\n    tag.src = uri;\n    tag.async = true;\n    tag.onload = () => {\n      resolve();\n    };\n  var firstScriptTag = document.getElementsByTagName('script')[0];\n  firstScriptTag.parentNode.insertBefore(tag, firstScriptTag);\n});\n};\n\nif(typeof $3Dmolpromise === 'undefined') {\n$3Dmolpromise = null;\n  $3Dmolpromise = loadScriptAsync('https://3dmol.org/build/3Dmol.js');\n}\n\nvar viewer_16593068247434082 = null;\nvar warn = document.getElementById(\"3dmolwarning_16593068247434082\");\nif(warn) {\n    warn.parentNode.removeChild(warn);\n}\n$3Dmolpromise.then(function() {\nviewer_16593068247434082 = $3Dmol.createViewer($(\"#3dmolviewer_16593068247434082\"),{backgroundColor:\"white\"});\n$3Dmol.download(\"pdb:5WOG\", viewer_16593068247434082, {}, function() {\nviewer_16593068247434082.zoomTo();\n\tviewer_16593068247434082.setStyle({\"cartoon\": {\"color\": \"spectrum\"}});\n\tviewer_16593068247434082.setStyle({\"hetflag\": true},{\"stick\": {\"radius\": 0.3, \"singleBond\": false}});\n\tviewer_16593068247434082.zoomTo();\n\tviewer_16593068247434082.setStyle({\"chain\": [\"A\", \"B\"]},{\"cartoon\": {\"color\": \"yellow\"}});\n\tviewer_16593068247434082.addLabel(\"alpha subunits\",{\"fontColor\": \"yellow\", \"backgroundColor\": \"lightgray\"},{\"chain\": [\"A\", \"B\"]});\n\tviewer_16593068247434082.setStyle({\"chain\": [\"C\", \"D\"]},{\"cartoon\": {\"color\": \"blue\"}});\n\tviewer_16593068247434082.addLabel(\"beta subunits\",{\"fontColor\": \"blue\", \"backgroundColor\": \"lightgray\"},{\"chain\": [\"C\", \"D\"]});\n\tviewer_16593068247434082.setStyle({\"resn\": \"HOH\"},{\"sphere\": {\"radius\": 0.5}});\n\tviewer_16593068247434082.setStyle({\"resn\": \"HOH\"},{});\n\tviewer_16593068247434082.setStyle({\"chain\": \"C\", \"resi\": \"6\"},{\"stick\": {\"colorscheme\": \"redCarbon\"}});\n\tviewer_16593068247434082.setStyle({\"chain\": \"D\", \"resi\": \"6\"},{\"stick\": {\"colorscheme\": \"redCarbon\"}});\n\tviewer_16593068247434082.setStyle({\"chain\": \"C\", \"resi\": \"6\"},{\"stick\": {\"colorscheme\": \"redCarbon\"}});\n\tviewer_16593068247434082.setStyle({\"chain\": \"D\", \"resi\": \"6\"},{\"stick\": {\"colorscheme\": \"redCarbon\"}});\nviewer_16593068247434082.render();\n})\n});\n</script>",
      "text/html": [
       "<div id=\"3dmolviewer_16593068247434082\"  style=\"position: relative; width: 640px; height: 480px\">\n",
       "        <p id=\"3dmolwarning_16593068247434082\" style=\"background-color:#ffcccc;color:black\">You appear to be running in JupyterLab (or JavaScript failed to load for some other reason).  You need to install the 3dmol extension: <br>\n",
       "        <tt>jupyter labextension install jupyterlab_3dmol</tt></p>\n",
       "        </div>\n",
       "<script>\n",
